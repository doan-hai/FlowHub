...
<template>
  <div class="toolbar">
    ...
    <ElTooltip
      :content="i18n['tooltip.zoomReset']"
      placement="bottom"
    >
      <span
        class="command"
