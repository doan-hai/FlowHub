...
@NoArgsConstructor
@AllArgsConstructor
public class TaskDefOutput extends BaseEntity {

  @Schema(description = "ID của công việc", example = "1")
  private String id;

  @Schema(description = "ID của mẫu luồng công việc", example = "1")
  private Long workflowDefId;

  @Schema(description = "Tên của mẫu luồng công việc", example = "Order Processing Workflow")
